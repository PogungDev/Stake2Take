...
export function MetaMaskIcon({ size = 24, className = "" }: MetaMaskIconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 318.6 318.6" className={className} xmlns="http://www.w3.org/2000/svg">
      <style>
      ...
      <polygon
        className="st6"
        points="174.6,164.6 177.9,106.9 193,65.8 125.6,65.8 140.6,106.9 144.1,164.6 145.3,182.8 145.4,227.6 173.1,227.6 173.3,182.8"
      />
    </svg>
  )
}
